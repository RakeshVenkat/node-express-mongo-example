...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var alertPopup = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (_res.data && _res.data.status === 'success') {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            path = "".concat(type === 'userData' ? 'users/updateMe' : 'auth/updatePassword');
            console.log(path);
            _context.next = 6;
            return (0, _axios.default)({
              url: "http://localhost:3001/api/v1/".concat(path),
              data: data,
              method: 'PATCH'
            });
          ...
          case 6:
            ...
            if (res.data && res.data.status === 'Success') {
              (0, _alerts.showAlert)('success', 'Updated the user details successfully');
              location.reload(true);
            }
...
var updatePasswordFormEl = document.querySelector('.form-user-password');
...
if (updateUserFormEl) {
  updateUserFormEl.addEventListener('submit', function (e) {
    e.preventDefault();
    var name = e.target.name.value;
    var email = e.target.email.value;
    (0, _updateSettings.updateSettings)('userData', {
      name: name,
      email: email
    });
  });
...
if (updatePasswordFormEl) {
  updatePasswordFormEl.addEventListener('submit', function (e) {
    e.preventDefault();
    var currentPassword = e.target.passwordCurrent.value;
    var newPassword = e.target.password.value;
    var passwordConfirm = e.target.passwordConfirm.value;
